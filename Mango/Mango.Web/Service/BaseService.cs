...
namespace Mango.Web.Service
{
    ...
    {
        private readonly IHttpClientFactory _httpClientFactoory;
        public BaseService(IHttpClientFactory httpClientFactory) 
        { 
            _httpClientFactoory = httpClientFactory;
        }
        ...
        public async Task<ResponseDto?> SendAsync(RequestDto requestDto)
        {
            try
            {
                HttpClient client = _httpClientFactoory.CreateClient("MangoAPI");
